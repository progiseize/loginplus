 ...
 */
class modLoginPlus extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 300316;     // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'loginplus';
        ...
        if($version[0] > 16): $this->picto='fa-user-lock_fas_#6c6aa8';
        ...
        $this->langfiles = array("loginplus@loginplus");
